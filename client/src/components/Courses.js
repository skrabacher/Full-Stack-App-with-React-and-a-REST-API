    ...
    render() {
      ...
      return (
        <div className="bounds">
          { courseLinks }
            {/* LINK TO CREATE COURSE BELOW need to change to: `/courses/create` once create page is ready*/}
          <div className="grid-33"><Link to="/courses/create" className="course--module course--add--module" href="create-course.html">
